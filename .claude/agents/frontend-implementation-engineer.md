...
Read `lifeDiary/AGENTS.md`, the approved plan, Web Experience Designer decisions, Browser
...
- manual browser verification and narrow measurable e2e gates permitted by
  `lifeDiary/AGENTS.md`;
- `.docs/frontend-integration-changelog.md` after implementation.
