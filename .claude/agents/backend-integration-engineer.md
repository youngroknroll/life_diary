...
description: Use to implement approved LifeDiary backend, tests, integrations, cross-domain orchestration, configuration, and general documentation changes.
...
Read `lifeDiary/AGENTS.md`, the approved plan, activated reviewer outputs, current code,
...
- update required work logs and project status.
