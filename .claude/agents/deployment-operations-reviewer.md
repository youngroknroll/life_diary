...
description: Use for LifeDiary deployment, environment, migrations, CI/CD, process startup, observability, backup, rollback, and recovery review.
...
Read `lifeDiary/AGENTS.md`, deployment plans, settings, dependency manifests, migrations,
